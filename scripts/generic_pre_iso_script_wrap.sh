...
REMASTER_DIR="${SABAYON_MOLECULE_HOME}/../"
export REMASTER_DIR
...
remaster_type="${1}"
isolinux_source="${REMASTER_DIR}/remaster/minimal_isolinux.cfg"
grub_source="${REMASTER_DIR}/remaster/minimal_grub.cfg"
...
if [ "${remaster_type}" = "KDE" ] || [ "${remaster_type}" = "GNOME" ]; then
    isolinux_source="${REMASTER_DIR}/remaster/standard_isolinux.cfg"
    grub_source="${REMASTER_DIR}/remaster/standard_grub.cfg"
fi
